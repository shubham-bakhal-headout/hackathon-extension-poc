...
export const MESSAGES = Object.freeze({
  ...
  /**
   * Content -> worker: after the agent has paid manually on the vendor tab,
   * run the script's `confirmAfterPayment()` to read the order reference.
   */
...
export const ERROR_CODES = Object.freeze({
  ...
  /** No prior PAYMENT_REQUIRED run to confirm. */
